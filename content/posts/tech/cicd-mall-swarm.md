...
![image-20230315161553373](/images/image-20230315-161553.png)
...
![image-20230315161635537](/images/image-20230315-161635.png)
...
![image-20230315162316804](/images/image-20230315-162316.png)
...
![image-20230315171029905](/images/image-20230315-171029.png)

新增 ssh 凭据

![image-20230315172425485](/images/image-20230315-172425.png)

新增 ssh 配置，配置好之后右下角测试一下，连接正常后保存

![image-20230315172224961](/images/image-20230315-172224.png)

新增 maven 配置

![image-20230315170741500](/images/image-20230315-170741.png)
...
![image-20230315172813560](/images/image-20230315-172813.png)

关闭代理，保存

![image-20230315172855436](/images/image-20230315-172855.png)

分配管理员、运维和 other 三个角色，分别配置对应权限

![image-20230315173418268](/images/image-20230315-173418.png)

![image-20230315173251456](/images/image-20230315-173251.png)

将用户和角色绑定

![image-20230315173353689](/images/image-20230315-173353.png)
...
![image-20230315174825623](/images/image-20230315-174825.png)

修改默认密码

![image-20230316102521034](/images/image-20230316-102521.png)

## 4.3 上传项目

新建空白项目

![image-20230316100124782](/images/image-20230316-100124.png)

新建 mall-swarm 项目

![image-20230316103923131](/images/image-20230316-103923.png)
...
![image-20230316101527597](/images/image-20230316-101527.png)

修改一下 docker.host 变量

![image-20230316101902285](/images/image-20230316-101902.png)
...
![image-20230316103602343](/images/image-20230316-103602.png)
...
![image-20230316123226022](/images/image-20230316-123226.png)
...
![image-20230316105111389](/images/image-20230316-105111.png)
...
![image-20230316110813031](/images/image-20230316-110813.png)
...
> 需要创建一个 mall 用户并设置虚拟 host 为/mall
  ...
  ![image-20230316121205905](/images/image-20230316-121205.png)

  - 创建一个新的虚拟 host 为 /mall

  ![image-20230316121307706](/images/image-20230316-121307.png)

  - 点击 mall 用户进入用户配置界面

  ![image-20230316121408922](/images/image-20230316-121408.png)

  - 给 mall 账户配置虚拟 host /mall 的权限

  ![image-20230316121547316](/images/image-20230316-121547.png)
...
nacos
  ...
  ![image-20230316124618771](/images/image-20230316-124618.png)

  - 全部上传完成

  ![image-20230316124828650](/images/image-20230316-124828.png)
...
![image-20230316125833420](/images/image-20230316-125833.png)
...
![image-20230316131035301](/images/image-20230316-131035.png)

源码管理

![image-20230316131241019](/images/image-20230316-131241.png)
...
![image-20230316131838994](/images/image-20230316-131838.png)

再创建一个构建，通过 SSH 去执行 `sh` 脚本，这里执行的是 `mall-admin` 的运行脚本：

![image-20230316132503984](/images/image-20230316-132503.png)
...
![image-20230316132845976](/images/image-20230316-132845.png)

修改第二步构建中的 pom 文件位置和第三步构建中的 sh 文件位置

![image-20230316133013058](/images/image-20230316-133013.png)

## 6.3 开始构建

单击开始构建即可开始构建任务，可以实时看到任务的控制台输出

![image-20230316134827150](/images/image-20230316-134827.png)
