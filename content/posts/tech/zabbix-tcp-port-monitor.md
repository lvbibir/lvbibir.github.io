...
![image-20231019161050562](/images/image-20231019-161050.png)

## 2.2 创建应用集

![image-20231019165227390](/images/image-20231019-165227.png)

## 2.3 创建监控项

![image-20231207151703881](/images/image-20231207-151703.png)

八条链路都创建一下

![image-20231207151818203](/images/image-20231207-151818.png)

在最新数据处看下键值获取是否正常

![image-20231207151953485](/images/image-20231207-151953.png)

## 2.4 创建触发器

这里的表达式代表如果连续的两个值的最小值不为 0 则触发告警, 即连续两次值都不为 0 触发告警, 这是考虑到整体网络比较复杂, 网络波动可能会导致误报

![image-20231207152335550](/images/image-20231207-152335.png)

八条链路分别添加一下触发器

![image-20231207152847941](/images/image-20231207-152847.png)

## 2.5 配置告警动作

![image-20231207152936737](/images/image-20231207-152936.png)

## 2.6 测试验证

我这里是找网络侧的同事中断了一下链路进行测试的, 各位可以自行选择适合自己的方法

![image-20231207153129294](/images/image-20231207-153129.png)
...
![image-20231207153341550](/images/image-20231207-153341.png)

在 `监测中` -> `聚合图形` 处添加聚合图形, 三台主机, 选择一行显示出来

![image-20231207153748336](/images/image-20231207-153748.png)

进入刚才创建的聚合图形, 选择右上角的编辑聚合图形, 然后点击 `更改` 添加图形

![image-20231207154620691](/images/image-20231207-154620.png)

把三个节点都添加一下

![image-20231207154840761](/images/image-20231207-154840.png)
