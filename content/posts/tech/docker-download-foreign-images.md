...
![image-20230309160649438](/images/image-20230309-160649.png)
...
![image-20230309163259040](/images/image-20230309-163259.png)
...
![image-20230309160101014](/images/image-20230309-160101.png)

### 1.2.2 进入个人实例创建命名空间

![image-20230309160146287](/images/image-20230309-160146.png)

### 1.2.3 创建访问凭证

![image-20230309160252483](/images/image-20230309-160252.png)

### 1.2.4 绑定 github 账号

![image-20230309160359915](/images/image-20230309-160359.png)

### 1.2.5 新建镜像仓库

![image-20230309162613107](/images/image-20230309-162613.png)

指定刚才创建的 github 仓库，记得勾选海外机器构建

![image-20230309162914840](/images/image-20230309-162914.png)

### 1.2.6 新建构建

![image-20230309163430105](/images/image-20230309-163430.png)

手动触发构建，正常状况应该可以看到构建成功

![image-20230309163539554](/images/image-20230309-163539.png)

### 1.2.7 镜像下载

操作指南里可以看到如何下载镜像，标签即刚才**新建构建**时指定的**镜像版本**

![image-20230309163731277](/images/image-20230309-163731.png)
...
![image-20230309164622746](/images/image-20230309-164622.png)

稍等一小会可以看到镜像已经搬运到 dockerhub 了

![image-20230309164858625](/images/image-20230309-164858.png)

# 3 Docker Playground

[Docker Playground](https://labs.play-with-docker.com/) 是一个免费的线上 docker 环境，由于是外网环境所以下载镜像、推送到 dockerhub 都很快，也可以直接推到阿里云的仓库

![image-20230309170605907](/images/image-20230309-170605.png)
